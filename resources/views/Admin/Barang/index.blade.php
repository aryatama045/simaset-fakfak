    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header justify-content-between">
                ...
                @if($hakTambah > 0)
                <div>
                    <a class="modal-effect btn btn-success-light" onclick="generateID()" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#modalimport">Import <i class="fe fe-arrow-top"></i></a>
