    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header justify-content-between">
                ...
                @if($hakTambah > 0)
                <div>
                    <a href="{{ URL::to('user-export/xlsx') }}" class="btn btn-success">Export Excel <i class="fe fe-file-excel-o"></i></a>
                    <a class="modal-effect btn btn-success-light" onclick="generateID()" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#modalimport">Import <i class="fe fe-arrow-up"></i></a>
