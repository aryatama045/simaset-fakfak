    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Tambah Pegawai</h6><button aria-label="Close" class="btn-close"
                    data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
            <div class="form-group">
                    <label for="nip" class="form-label">NIP Pegawai <span class="text-danger">*</span></label>
                    <input type="text" name="nip" class="form-control" placeholder="">
                </div>
                <div class="form-group">
                    <label for="nama_lengkap" class="form-label">Nama Pegawai <span class="text-danger">*</span></label>
    ...
    <script>
        function checkForm() {
            ...
            if (nip == "") {
                ...
                $("input[name='nip']").addClass('is-invalid');
                setLoading(false);
                return false;
            } else {
                submitForm();
        ...
        function resetValid() {
            $("input[name='nip']").removeClass('is-invalid');
        };

        function reset() {
            resetValid();
            $("input[name='nip']").val('');
            $("input[name='pegawai_nama']").val('');
