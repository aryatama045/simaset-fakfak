        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->editColumn('checkbox', function($row) {
                    $checkbox = '<input type="checkbox" name="barang_checkbox[]" class="barang_checkbox" value='. $row->barang_id .'>';
                    return $checkbox;
                })
                    ...
                    if ($hakEdit > 0 && $hakDelete > 0) {
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownNoAnimation">
                                <a class="dropdown-item btn modal-effect text-primary btn-sm" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#Umodaldemo8" data-bs-toggle="tooltip" data-bs-original-title="Edit" onclick=update(' . json_encode($array) . ')><span class="fe fe-edit text-success fs-14"></span></a>
                                <a class="dropdown-item btn modal-effect text-danger btn-sm" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#Hmodaldemo8" onclick=hapus(' . json_encode($array) . ')><span class="fe fe-trash-2 fs-14"></span></a>
                            </div>
                        </div>
                        ';
